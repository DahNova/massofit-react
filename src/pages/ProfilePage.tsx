    ...
    <div className="flex flex-col bg-background text-textPrimary font-sans">
      ...
      <section className="bg-primary text-white py-16 relative overflow-hidden">
        <div className="container mx-auto flex flex-col md:flex-row items-center gap-12 px-4">
          <div className="md:w-1/2 space-y-6 z-10">
            ...
            <p className="text-lg text-secondary">Massoterapista MCB certificato, specializzato in massoterapia professionale e riabilitativa.</p>
      ...
      <section className="py-16 bg-surface">
        <div className="container mx-auto px-4 space-y-8">
          ...
          <h3 className="text-2xl font-semibold mt-8">Qualifiche</h3>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 space-y-8">
          <h2 className="text-3xl font-bold">Servizi Offerti</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-6 mt-6">
            {[
              { icon: <HeartPulse size={32} className="text-primary" />, label: 'Massoterapia' },
              { icon: <Handshake size={32} className="text-primary" />, label: 'Riabilitazione' },
              { icon: <Users size={32} className="text-primary" />, label: 'Trattamenti Sportivi' },
              { icon: <MessageCircle size={32} className="text-primary" />, label: 'Consulenze' },
              { icon: <HeartPulse size={32} className="text-primary" />, label: 'Benessere' },
            ].map((service, idx) => (
              <div key={idx} className="flex flex-col items-center bg-surface rounded-lg p-4 shadow hover:shadow-md transition">
                {service.icon}
                <p className="mt-2 font-semibold text-textPrimary text-center">{service.label}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-surface">
        <div className="container mx-auto px-4 space-y-8">
          <h2 className="text-3xl font-bold">Cosa dicono i pazienti</h2>
          <div className="grid md:grid-cols-2 gap-8 mt-6">
            {[
              ...
              <div key={idx} className="bg-white rounded-lg shadow p-6 space-y-4">
                ...
                <p className="italic text-textSecondary">"{review.text}"</p>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
          <div className="md:w-1/2 space-y-6">
            <h2 className="text-3xl font-bold">Prenota una consulenza</h2>
            <p className="text-textSecondary">Contattami per fissare un appuntamento o per ricevere maggiori informazioni sui trattamenti offerti.</p>
            <a href="/contatti" className="inline-block bg-primary hover:bg-secondary text-white px-6 py-3 rounded-full transition">Contattami</a>
          </div>
